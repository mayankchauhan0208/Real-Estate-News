...
assert.equal(isAllowedSource("https://www.lokmattimes.com/business/"), true);
assert.equal(isAllowedSource("https://www.business-standard.com/search?q=REAL%20ESTATE"), true);
...
assert.equal(isAllowedSource("https://realty.economictimes.indiatimes.com/"), true);
...
assert.equal(isAllowedSource("https://timesofindia.indiatimes.com/real-estate"), true);
assert.equal(isAllowedSource("https://timesofindia.indiatimes.com/real-estate/news"), true);
assert.equal(isAllowedSource("https://www.constructionworld.in/"), true);
...
assert.equal(isAllowedSource("https://haryanarera.gov.in"), true);
assert.equal(isAllowedSource("https://tcpharyana.gov.in"), true);
assert.equal(isAllowedSource("https://mohua.gov.in"), true);
assert.equal(isAllowedSource("https://www.pib.gov.in"), true);
assert.equal(isAllowedSource("https://dda.gov.in"), true);
assert.equal(isAllowedSource("https://gmda.gov.in"), true);
assert.equal(isAllowedSource("https://nhai.gov.in"), true);
...
assert.equal(isAllowedSource("https://www.whitelandcorp.com"), true);
...
assert.equal(isAllowedSource("https://indianexpress.com/section/cities/delhi/"), true);
...
assert.equal(isAllowedSource("https://timesofindia.indiatimes.com/rssfeeds/8021716.cms"), true);
assert.equal(isAllowedSource("https://www.hindustantimes.com/feeds/rss/cities/noida-news/rssfeed.xml"), true);
assert.equal(isAllowedSource("https://realty.economictimes.indiatimes.com/tag/noida"), true);
assert.equal(isAllowedSource("https://realty.economictimes.indiatimes.com/tag/greater%2Bnoida"), true);
assert.equal(isAllowedSource("https://realty.economictimes.indiatimes.com/amp/tag/greater%2Bnoida"), true);
assert.equal(isAllowedSource("https://realty.economictimes.indiatimes.com/tag/jewar"), true);
assert.equal(isAllowedSource("https://realty.economictimes.indiatimes.com/tag/yamuna%2Bexpressway"), true);
assert.equal(isAllowedSource("https://realty.economictimes.indiatimes.com/tag/noida%2Bauthority"), true);
assert.equal(isAllowedSource("https://realty.economictimes.indiatimes.com/rss/residential"), true);
assert.equal(isAllowedSource("https://realty.economictimes.indiatimes.com/rss/commercial"), true);
assert.equal(isAllowedSource("https://www.hindustantimes.com/cities/noida-news"), true);
assert.equal(isAllowedSource("https://www.hindustantimes.com/topic/noida-authority/news"), true);
assert.equal(isAllowedSource("https://www.niairport.in/en/company/news/overview/news-overview"), true);
assert.equal(isAllowedSource("https://www.yamunaexpresswayauthority.com/web/announcement/"), true);
assert.equal(isAllowedSource("https://up-rera.in"), true);
assert.equal(isAllowedSource("https://noidaauthorityonline.in"), true);
assert.equal(isAllowedSource("https://www.abacorp.in"), true);
assert.equal(isAllowedSource("https://www.acegroupindia.com"), true);
assert.equal(isAllowedSource("https://www.gaursonsindia.com"), true);
assert.equal(isAllowedSource("https://www.sayahomes.com"), true);
assert.equal(isAllowedSource("https://www.sikka.in"), true);
assert.equal(isAllowedSource("https://www.supertechlimited.com"), true);
assert.equal(isAllowedSource("https://gnida.up.gov.in/en/news"), true);
assert.equal(isAllowedSource("https://gnida.up.gov.in/en/announcements"), true);
assert.equal(isAllowedSource("https://www.atsgreens.com/blog"), true);
assert.equal(isAllowedSource("https://www.mahagunindia.com/media"), true);
assert.equal(isAllowedSource("https://countygroup.in/"), true);
assert.equal(isAllowedSource("https://www.prateekgroup.com/blog"), true);
assert.equal(isAllowedSource("https://www.gulshangroup.com/"), true);
assert.equal(isAllowedSource("https://www.aba-corp.com/"), true);
assert.equal(isAllowedSource("https://indianexpress.com/about/noida-authority/"), true);
assert.equal(isAllowedSource("https://timesofindia.indiatimes.com/city/noida"), true);
assert.equal(isAllowedSource("https://housing.com/news/"), true);
assert.equal(isAllowedSource("https://www.squareyards.com/blog"), true);
assert.equal(
  isPublishableArticle(
    publishable({
