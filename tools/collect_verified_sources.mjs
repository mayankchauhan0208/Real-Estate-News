...
const seeds = [
  ...
  ["Brigade Group", "Developer", "NCR", "https://www.brigadegroup.com"],
  ["Oberoi Realty", "Developer", "NCR", "https://www.oberoirealty.com"],
  ["Mahindra Lifespaces", "Developer", "NCR", "https://www.mahindralifespaces.com"],
  ["Shapoorji Pallonji Real Estate", "Developer", "NCR", "https://www.shapoorjirealestate.com"],
  ["Puravankara", "Developer", "NCR", "https://www.puravankara.com"],
  ["Kolte-Patil Developers", "Developer", "NCR", "https://www.koltepatil.com"],
  ["Embassy Group", "Developer", "NCR", "https://www.embassyindia.com"],
  ["Phoenix Mills", "Developer", "NCR", "https://www.thephoenixmills.com"],
  ["TVS Emerald", "Developer", "NCR", "https://www.tvsemerald.com"],
  ["Casagrand", "Developer", "NCR", "https://www.casagrand.co.in"],
  ["Rustomjee", "Developer", "NCR", "https://www.rustomjee.com"],
  ["Runwal Group", "Developer", "NCR", "https://runwal.com"],
  ["Kalpataru", "Developer", "NCR", "https://www.kalpataru.com"],
  ["Hiranandani Group", "Developer", "NCR", "https://www.hiranandani.com"],
  ["House of Hiranandani", "Developer", "NCR", "https://www.houseofhiranandani.com"],
  ["K Raheja Corp", "Developer", "NCR", "https://www.krahejacorp.com"],
  ["RMZ Corp", "Developer", "NCR", "https://www.rmzcorp.com"],
  ["Salarpuria Sattva", "Developer", "NCR", "https://www.sattvagroup.in"],
  ["Aparna Constructions", "Developer", "NCR", "https://www.aparnaconstructions.com"],
  ["My Home Group", "Developer", "NCR", "https://www.myhomeconstructions.com"],
  ["Navin's", "Developer", "NCR", "https://www.navins.in"],
  ["Alliance Group", "Developer", "NCR", "https://www.alliancein.com"],
  ["Assetz Property Group", "Developer", "NCR", "https://www.assetzproperty.com"],
  ["Total Environment", "Developer", "NCR", "https://www.total-environment.com"],
  ["Provident Housing", "Developer", "NCR", "https://www.providenthousing.com"],
  ["Jain Housing", "Developer", "NCR", "https://www.jainhousing.com"],
  ["Century Real Estate", "Developer", "NCR", "https://www.centuryrealestate.in"],
  ["DSR Group", "Developer", "NCR", "https://www.dsrinfra.com"],
  ["Parsvnath Developers", "Developer", "NCR", "https://www.parsvnath.com"],
  ["Unitech", "Developer", "NCR", "https://www.unitechgroup.com"],
  ["NBCC India", "Developer", "NCR", "https://www.nbccindia.in"],
  ["MRG World", "Developer", "Gurugram", "https://www.mrgworld.com"],
  ["AIPL", "Developer", "Gurugram", "https://www.aipl.com"],
  ["Bestech", "Developer", "Gurugram", "https://www.bestechgroup.com"],
  ["Vatika Group", "Developer", "Gurugram", "https://www.vatikagroup.com"],
  ["Suncity Projects", "Developer", "Gurugram", "https://www.suncityprojects.com"],
  ["Orris Group", "Developer", "Gurugram", "https://www.orris.in"],
  ["Raheja Developers", "Developer", "Gurugram", "https://www.rahejabuilders.com"],
  ["Puri Constructions", "Developer", "Faridabad", "https://www.puriconstructions.com"],
  ["Anant Raj", "Developer", "Gurugram", "https://www.anantrajlimited.com"],
  ["Trident Realty", "Developer", "NCR", "https://www.tridentrealty.co.in"],
  ["Nimbus Group", "Developer", "Noida", "https://www.nimbusgroup.net.in"],
  ["Ajnara India", "Developer", "Noida", "https://www.ajnara.com"],
  ["Civitech", "Developer", "Noida", "https://www.civitech.co.in"],
  ["Dasnac", "Developer", "Noida", "https://www.dasnac.com"],
  ["Migsun Group", "Developer", "Noida", "https://www.migsun.com"],
  ["Nirala World", "Developer", "Noida", "https://www.niralaworld.com"],
  ["SKA Group", "Developer", "Noida", "https://www.skagroup.in"],
  ["Fusion Buildtech", "Developer", "Noida", "https://www.fusionbuildtech.com"],
  ["Irish Infrastructure", "Developer", "Noida", "https://irishgroup.in"],
  ["Galaxy Group", "Developer", "Noida", "https://www.galaxygroup.co.in"],
  ["RG Group", "Developer", "Noida", "https://www.rggroupindia.com"],
  ["Logix Group", "Developer", "Noida", "https://www.logixgroup.in"],
  ["Earth Infrastructure", "Developer", "NCR", "https://www.earthinfra.com"],
  ["Amrapali Group", "Developer", "Noida", "https://www.amrapali.in"],
  ["Ambience Group", "Developer", "Gurugram", "https://www.ambiencegroup.in"],
  ["IREO", "Developer", "Gurugram", "https://www.ireoworld.com"],
  ["4S Developers", "Developer", "Gurugram", "https://www.4sdevelopers.com"],
  ["Roots Developers", "Developer", "Gurugram", "https://www.rootsdevelopers.com"],
  ["NeoLiv", "Developer", "NCR", "https://www.neoliv.in"],
  ["Adore RealTech", "Developer", "Faridabad", "https://www.adoregroup.in"],
  ["Amolik Group", "Developer", "Faridabad", "https://www.amolikgroup.com"],
  ["Auric Group", "Developer", "Faridabad", "https://auricgroup.in"],
  ["Bhumika Group", "Developer", "NCR", "https://www.bhumikagroup.com"],
  ["Reach Group", "Developer", "Gurugram", "https://www.reachgroup.in"],
  ["ASF Group", "Developer", "Gurugram", "https://www.asfinfrastructure.com"],
  ["Spaze Group", "Developer", "Gurugram", "https://www.spaze.in"],
  ["ILD Group", "Developer", "Gurugram", "https://www.ild.co.in"],
  ["MGF Developments", "Developer", "Gurugram", "https://www.mgf.co"],
  ["Today Homes", "Developer", "NCR", "https://www.todayhomes.co.in"],
  ["CHD Developers", "Developer", "NCR", "https://www.chddevelopers.com"],
  ["Imperia Structures", "Developer", "NCR", "https://www.imperiastructures.com"],
  ["Mapsko Group", "Developer", "Gurugram", "https://www.mapskogroup.com"],
  ["Ansal API", "Developer", "NCR", "https://www.ansalapi.com"],
  ["Ansal Housing", "Developer", "NCR", "https://www.ansals.com"],
  ["Uppal Housing", "Developer", "NCR", "https://www.uppal.co.in"],
  ["SG Estates", "Developer", "Noida", "https://www.sgestates.in"],
  ["SVP Group", "Developer", "Noida", "https://www.svpgroup.in"],
  ["Landcraft", "Developer", "Noida", "https://www.landcraft.in"],
  ["Techman Buildwell", "Developer", "Noida", "https://www.techmanbuildwell.com"],
  ["KDP Infrastructure", "Developer", "Noida", "https://www.kdpgroup.co.in"],
  ["Charms Group", "Developer", "Noida", "https://www.charmsindia.com"],
  ["Vibhor Group", "Developer", "Noida", "https://www.vibhorgroup.com"],
  ["Divyansh Group", "Developer", "Noida", "https://www.divyanshgroup.com"],
  ["SCC Builders", "Developer", "Noida", "https://www.sccsapphire.com"],
  ["Uninav Developers", "Developer", "Noida", "https://www.uninavdevelopers.com"],
  ["Star Raison", "Developer", "Noida", "https://www.starraison.com"],
  ["Avalon Group", "Developer", "Faridabad/Gurugram", "https://www.avalongroup.co.in"],
  ["BPTP", "Developer", "Faridabad/Gurugram", "https://www.bptp.com"],
  ["R-Tech Developers", "Developer", "NCR", "https://www.rtechgroup.co.in"],
  ["Nimai Developers", "Developer", "Faridabad/Gurugram", "https://www.nimaidevelopers.com"]
];

const developerPageTypePaths = [
  ["Media Centre", "/media"],
  ["News Category", "/news"],
  ["Newsroom", "/newsroom"],
...
function buildCandidates() {
  ...
  for (const [company, category, region, base] of seeds) {
    ...
    const paths = category === "Developer" ? developerPageTypePaths : pageTypePaths;
